...
export declare const fetchOauthTokens: (credentials: DAVCredentials) => Promise<DAVTokens>;
export declare const refreshAccessToken: (credentials: DAVCredentials) => Promise<{
    access_token?: string;
    expires_in?: number;
}>;
export declare const getOauthHeaders: (credentials: DAVCredentials) => Promise<{
    tokens: DAVTokens;
    headers: {
        authorization?: string;
    };
